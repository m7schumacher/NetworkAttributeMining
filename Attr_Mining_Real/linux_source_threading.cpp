...
string partial_path = "/home/mschuee/Downloads/";
...
void *Thread_Mine(void *threadid)
{
	...
	cout << "I begin at: " << begin << " and end at: " << end << endl;
...
int main(int argc, char *argv[])
{
	...
	chunk_size = singles.size() / NUM_THREADS;
	pthread_t threads[NUM_THREADS];

	int start_s = clock();

	cout << "Number of threads: " << NUM_THREADS << endl;
	cout << "Size of chunks: " << chunk_size << endl;
